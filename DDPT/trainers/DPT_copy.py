...
# ================================================================= #
# ???VPT DEEP+CoOp(Frozen)+CLIP(Frozen)????                #
# ================================================================= #
...
class DPT(TrainerX):
    ...
    def generate_metric(self):
      ...
      #print('SIZE',len(self.test_loader))
      ...
      for batch in self.test_loader:
        ...
        if(batch_num!=84):  
          for img_num in range(50):
            ...
            if(big_img_num==0 or big_img_num==45):
              print('impath',impath)
        ...
        print(f'BATCHES DONE {batch_num}/85 ')
      
      print('TOTAL TUMOR IMAGES',total_tumor_images)
      
      print('AVG DICE SCORE- 0.4', total_dice_score_4/total_tumor_images)
      print('AVG DICE SCORE- 0.5', total_dice_score_5/total_tumor_images)
      print('AVG DICE SCORE- 0.6', total_dice_score_6/total_tumor_images)
      
      print('AVG IOU - 0.4',total_iou_4/total_tumor_images)
      print('AVG IOU - 0.5',total_iou_5/total_tumor_images)
      print('AVG IOU - 0.6',total_iou_6/total_tumor_images)
      
      print('AVG AUPRC - 0.4',total_auprc_4/total_tumor_images)
      print('AVG AUPRC - 0.5',total_auprc_5/total_tumor_images)
      print('AVG AUPRC - 0.6',total_auprc_6/total_tumor_images)

        
      
    def check(self):
    
      '''batches=[0,5,10,15,20,25,30,35,40,45]
      
      img_nums=[0,1,6,11,16,21,26,31,36,41]
      for ind in range(10):
        
        img_num=img_nums[ind]
        ...
        for i in self.test_loader:
          ...
          if(c==batch_num):
            ...
            print(f'{batch_num}-{img_num}-{label}')
            break
          c+=1 
        #print('done')'''
