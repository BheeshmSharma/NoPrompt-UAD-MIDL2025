...
#from .model_update import build_model
...
#ALL THE PRETRAINED MODELS FROM OPENAI
_MODELS = {
...
def _download(url: str, root: str = os.path.expanduser("~/.cache/clip")):
    #Function to download the particular pt file and return the final location of the file
    #Called at the load function below

    #url -> going to have the url of the model like in the Dictionary above
    #root -> where the file is going to be saved now, default = '~/.cache/clip'
